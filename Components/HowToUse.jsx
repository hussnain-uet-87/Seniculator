    ...
    <section className='max-w-7xl mx-6 md:mx-12 border-b-2 border-b-gray-400 p-6 pb-16 mb-10' style={{fontFamily: 'Poppins'}}>
        <div className='flex items-center flex-col md:flex-row '>
            <div className='flex-1 items-center '>
                ...
                <div className='max-w-[500px] space-y-4 mt-6  flex flex-col'>
                    <div className='flex-1 flex items-center border-2 border-amber-400 bg-amber-100 p-3 md:p-5 rounded-3xl'>
                        <img style={{boxShadow: "0px 0px 5px 3px #fbbf24" }} className='h-[30px] md:h-[50px]  rounded-3xl shadow-2xl shadow-amber-800' src="../public/number-one.png" alt="" />
                    ...
                    <div className='flex-1 flex items-center bg-fuchsia-100 border-2 border-fuchsia-400 p-3 md:p-5 rounded-3xl'>
                        <img style={{boxShadow: "0px 0px 5px 3px #e879f9" }} className='h-[30px] md:h-[50px]  rounded-3xl shadow-2xl shadow-amber-800' src="../public/number-2.png" alt="" />
                        <div className='ml-4  text-sm'>
                    ...
                    <div  className='flex-1 flex items-center border-2 border-sky-400 bg-sky-100 p-3 md:p-5 rounded-3xl'>
                        <img style={{boxShadow: "0px 0px 5px 3px #7ed3f5" }} className='h-[30px] md:h-[50px] rounded-3xl shadow-2xl shadow-amber-800' src="../public/number-3.png" alt="" />
                        <div className='ml-4  text-sm'>
            ...
            <div className='flex-1 mt-[50px] md:mt-0 ml-6 flex items-center justify-center'>
                <img src="../public/hand.png" className='lg:w-[400px] w-[250px]' alt="" />
            </div>
        </div>
    </section>
  )

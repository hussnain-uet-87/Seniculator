  ...
  return (
    <section className='max-w-7xl p-6  mx-auto bg-[#fbfbfb]'>
      ...
      <div className='lg:ml-22  md:ml-10 ml-6'>
        <h2 className='font-[Poppins] text-[#94402c] text-xl md:text-2xl lg:text-4xl font-bold'>GPA Calculation Made Easy</h2>
        <p className='text-xl mt-6'>Confused about your GPA? Stop guessing and start calculating! Seniculator makes it <span className='text-xl font-["Schoolbell"] text-[#bc4327] font-bold md:text-2xl'>quick</span>, <span className='text-xl font-["Schoolbell"] text-[#5e9448] font-bold md:text-2xl'>accurate</span>, and <span className='text-xl font-["Schoolbell"] text-[#84228a] font-bold md:text-2xl'>stress-free </span>to find your GPA in just a few clicks. Whether you're prepping for scholarships, semester wrap-ups, or just keeping track, we’ve got your back. No sign-ups, no fuss.</p>
